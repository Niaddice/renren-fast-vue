    ...
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        <!--<el-submenu index="3">-->
          ...
          <!--<el-menu-item index="2-1"><a href="//github.com/daxiongYang/erp-admin-vue" target="_blank">前端</a></el-menu-item>-->
          <!--<el-menu-item index="2-2"><a href="//git.oschina.net/renrenio/erp-admin" target="_blank">后台</a></el-menu-item>-->
