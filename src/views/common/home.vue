<template>
  <div class="mod-home">
    <h3>项目介绍</h3>
    <ul>
      <li>erp-admin-vue基于vue、element-ui构建开发，实现<a href="https://gitee.com/renrenio/erp-admin" target="_blank">erp-admin</a>后台管理前端功能，提供一套更优的前端解决方案</li>
    ...
    <ul>
      ...
      <li>前端Git地址：<a href="//github.com/daxiongYang/erp-admin-vue" target="_blank">github.com/daxiongYang/erp-admin-vue</a></li>
      <li>后台Git地址：<a href="//git.oschina.net/renrenio/erp-admin" target="_blank">git.oschina.net/renrenio/erp-admin</a></li>
